...
resource "conjur_membership" "test_group_membership" {
...
output "membership_id" {
  value = conjur_membership.test_group_membership.id
}

output "create_status" {
  value = conjur_membership.test_group_membership.id != "" ? "success" : "fail"
}